...
class CustomGameWidget<T extends Game> extends StatefulWidget {
  ...
  /// }
  /// ```
  const CustomGameWidget.controlled({
  ...
  @override
  CustomGameWidgetState<T> createState() => CustomGameWidgetState<T>();
...
class CustomGameWidgetState<T extends Game> extends State<CustomGameWidget<T>> {
  late T currentGame;
  ...
  @override
  void didUpdateWidget(CustomGameWidget<T> oldWidget) {
